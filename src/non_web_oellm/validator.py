...
TOPICS = ["Literature", "Linguistics", "Politics", "Economics", "Law", "Science", "Technology", "Medicine", "Education", "Culture", "Journalism", "Society", "History", "Religion", "Philosophy", "Psychology", "Sports", "Entertainment", "Sociology", "Business", "Environment", "Other", "Unknown", "Public Administration"]
DATA_TYPES = ["ppt", "pptx", "zip","vtt", "aac", "m4a", "ogg", "wav", "pdf", "rtf", "mp4", "mp3", "txt", "html", "docx", "xlsx", "csv", "json", "xml", "doc"]
