...
TOPICS = ["Linguistics", "Politics", "Economics", "Law", "Science", "Technology", "Medicine", "Education", "Culture", "Journalism", "Society", "History", "Religion", "Philosophy", "Psychology", "Sports", "Entertainment", "Sociology", "Business", "Environment", "Other", "Unknown", "Public Administration"]
